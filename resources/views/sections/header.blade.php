<header class="bg-white border-b border-gray-100">
  <div class="max-w-6xl mx-auto px-4 sm:px-8">
    <div class="flex items-center justify-between py-6 sm:py-8">
      
      <!-- Left: Menu Toggle (Mobile & Desktop) -->
      <button @click="mobileMenu = !mobileMenu" class="text-black">
...
<div x-show="mobileMenu" 
     ...
     class="md:hidden bg-white border-b border-gray-100 shadow-sm">
    ...
    @if (has_nav_menu('primary_navigation'))
      <nav class="space-y-2">
        {!! wp_nav_menu([
            ...
            'link_class' => 'block px-3 py-2 text-black hover:text-gray-600 transition-colors text-sm',
            'echo' => false
        ]) !!}
      </nav>
    @endif
