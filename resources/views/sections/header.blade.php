<nav class="bg-white border-b border-gray-100">
  <div class="max-w-6xl mx-auto px-4 sm:px-8">
    <div class="relative flex items-center justify-between py-6 sm:py-8">
      ...
      <!-- Left: Menu Toggle -->
      <button @click="mobileMenu = !mobileMenu" class="relative inline-flex items-center justify-center text-black hover:text-gray-600 transition-colors">
  ...
  <div x-show="mobileMenu" 
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-8 py-4">
      @if (has_nav_menu('primary_navigation'))
        <div class="space-y-1">
          {!! wp_nav_menu([
              ...
              'link_class' => 'block px-3 py-2 text-black hover:bg-gray-50 hover:text-gray-600 transition-colors text-base font-medium',
              'echo' => false
          ]) !!}
        </div>
      @endif
      ...
      <a href="#" class="text-black hover:text-gray-600 transition-colors" aria-label="LinkedIn">
        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
